...
import no.ssb.lds.neo4j.algo.Cover;
import no.ssb.lds.neo4j.result.GraphResult;
import no.ssb.lds.neo4j.result.NodeResult;
import no.ssb.lds.neo4j.result.PathResult;
...
import static no.ssb.lds.neo4j.path.PathExplorer.NodeFilter.BLACKLIST_NODES;
import static no.ssb.lds.neo4j.path.PathExplorer.NodeFilter.END_NODES;
import static no.ssb.lds.neo4j.path.PathExplorer.NodeFilter.TERMINATOR_NODES;
import static no.ssb.lds.neo4j.path.PathExplorer.NodeFilter.WHITELIST_NODES;
